...
export default function Sign_Up()
{
    ...
    return (<main className="box-content flex flex-col items-center justify-center min-h-screen text-black font-poppins ">
        <div className={`p-4 ${loading&&"pointer-events-none opacity-50"} bg-white w-[90%] max-w-[430px]  flex flex-col gap-4 md:w-[400px] shadow-md rounded-2xl`}>
            <div>
            ...
            <form onSubmit={handleSubmit(handleSignup)}>
                ...
                <div className="mt-2">
                    <label className="text-sm text-gray-600 " htmlFor="email">Email Address  {errors.email && <span className="font-semibold text-red-800">Required*</span>}</label>
                ...
                {
                    error&&<div className="flex items-center justify-center gap-2 mt-4 text-sm text-center text-red-800 whitespace-pre-wrap ">
              ...
              <div className="mt-5 text-center ">
                    <p className="text-sm">Have an account? <a href="/signin" className="text-blue-800 underline ">Sign In</a></p>
              </div>
            </form>
        </div>
    </main>)
